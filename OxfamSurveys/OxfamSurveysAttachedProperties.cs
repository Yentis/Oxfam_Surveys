...
{
    public static class OxfamSurveysAttachedProperties
    {
        ...
        public static readonly DependencyProperty EncryptedPasswordProperty = DependencyProperty.RegisterAttached("EncryptedPassword", typeof(SecureString), typeof(OxfamSurveysAttachedProperties));
    }
}
